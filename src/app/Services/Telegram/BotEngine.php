        ...
        public function handle (array $update):void {
            ...
            if (in_array(strtolower($text), ['/start', 'start', 'старт'])) {
                ...
                if ($status === 'authorized') {
                    ...
                    $this->bot->sendPhoto($uid, $photoPath, "👋 Я - Василий Иванович, бот‑страж, чьё око видит каждый пакет, а рука правит конфигурациями с мудростью древних ярлов! Поведайте мне о ваших нуждах — и я исполню их во славу стабильной сети!", $keyboard);
                } else {
                    // Если гость — представляемся и просим логин
                    $welcome = "👋 Внемлите, мастера сетевых рун! Из туманных доков цифровой Вальгаллы явился я — <b>Василий Иванович</b>, бот‑страж, чьё око видит каждый пакет, а рука правит конфигурациями с мудростью древних ярлов. Пусть ваши свитчи будут крепки, а задержки — малы! Поведайте мне о ваших нуждах — и я исполню их во славу стабильной сети!\n"
                        . "Но прежде чем мы вступим в совместный поход по просторам сетевых доменов, отворите врата доступа: войдите в систему, дабы я узнал вас как доблестного союзника в битвах за безотказную связь!";
